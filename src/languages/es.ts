...
const translations = {
    ...
    spreadsheet: {
        ...
        importCategoriesSuccessfullDescription: ({categories}: SpreadCategoriesParams) => (categories > 1 ? `Se han añadido ${categories} categorías.` : 'Se ha añadido 1 categoría.'),
        importMembersSuccessfullDescription: ({members}: ImportMembersSuccessfullDescriptionParams) => (members > 1 ? `Se han añadido ${members} miembros.` : 'Se ha añadido 1 miembro.'),
        importTagsSuccessfullDescription: ({tags}: ImportTagsSuccessfullDescriptionParams) => (tags > 1 ? `Se han añadido ${tags} etiquetas.` : 'Se ha añadido 1 etiqueta.'),
    ...
    iou: {
        ...
        payerSettledWithMissingBankAccount: ({amount}: PayerSettledParams) => `pagó ${amount}. Añade una cuenta bancaria para recibir tu pago.`,
    ...
    workspace: {
        ...
        companyCards: {
            addCompanyCards: 'Añadir tarjetas de empresa',
        ...
        expensifyCard: {
            ...
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `emitió a ${assignee} una Tarjeta Expensify. La tarjeta se enviará una vez que se añadan los detalles de envío.`,
            ...
            addedShippingDetails: ({assignee}: AssigneeParams) => `${assignee} añadió los detalles de envío. La Tarjeta Expensify llegará en 2-3 días hábiles.`,
        ...
        people: {
            ...
            addedWithPrimary: 'Se añadieron algunos miembros con sus nombres de usuario principales.',
            invitedBySecondaryLogin: ({secondaryLogin}: SecondaryLoginParams) => `Añadido por nombre de usuario secundario ${secondaryLogin}.`,
        ...
        invoices: {
            ...
            invoiceBalanceSubtitle: 'Este es tu saldo actual de la recaudación de pagos de facturas. Se transferirá automáticamente a tu cuenta bancaria si has añadido una.',
            bankAccountsSubtitle: 'Añade una cuenta bancaria para hacer y recibir pagos de facturas.',
        },
        invite: {
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptTextPart2: 'para añadir tu tarjeta',
        ...
        rules: {
            ...
            expenseReportRules: {
                ...
                autoPayApprovedReportsLockedSubtitle: 'Ve a más funciones y habilita flujos de trabajo, luego añade pagos para desbloquear esta función.',
                ...
                unlockFeatureEnableWorkflowsSubtitle: ({featureName}: FeatureNameParams) => `y habilita flujos de trabajo, luego añade ${featureName} para desbloquear esta función.`,
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                managerAttachReceipt: `añadió un recibo`,
                ...
                addEmployee: ({email, role}: AddEmployeeParams) => `añadió a ${email} como ${role === 'miembro' || role === 'user' ? 'miembro' : 'administrador'}`,
    ...
    delegate: {
        ...
        enterMagicCode: ({contactMethod}: EnterMagicCodeParams) => `Por favor, introduce el código mágico enviado a ${contactMethod} para añadir un copiloto.`,
    ...
    debug: {
        ...
        reasonVisibleInLHN: {
            ...
            hasAddWorkspaceRoomErrors: 'Tiene errores al añadir sala de espacio de trabajo',
