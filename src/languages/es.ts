...
const translations = {
    ...
    iou: {
        ...
        error: {
            ...
            receiptFailureMessage: 'Hubo un error al subir su recibo. ',
            tryAgainMessage: 'Inténtelo de nuevo. ',
            alternativelyMessage: 'Alternativamente, ',
            saveFileMessage: 'guarde el archivo ',
            loseFileMessage: 'o descarta este error para eliminarlo.',
        ...
        dismissReceiptError: 'Descartar error de recibo',
        dismissReceiptErrorConfirmation: 'Una vez que descarte el error, no podrá recuperar el recibo.',
