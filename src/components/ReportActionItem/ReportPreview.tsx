...
function ReportPreview({
    ...
    const transactionsWithReceipts = ReportUtils.getTransactionsWithReceipts(iouReportID, true);
    ...
    const lastThreeTransactionsWithReceipts = transactionsWithReceipts.slice(0, 3);
