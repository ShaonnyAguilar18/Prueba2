...
function isArchivedNonExpenseReport(report: OnyxInputOrEntry<Report>, reportNameValuePairs?: OnyxInputOrEntry<ReportNameValuePairs>): boolean {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function isArchivedAnyReport(report: OnyxInputOrEntry<Report>, reportNameValuePairs?: OnyxInputOrEntry<ReportNameValuePairs>): boolean {
...
function getQuickActionDetails(
    ...
    const isValidQuickActionReport = !(isEmptyObject(quickActionReport) || isArchivedNonExpenseReport(quickActionReport, reportNameValuePairs));
